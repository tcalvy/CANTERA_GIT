...
if type == 'debit' : 
    ...
    min_fuel = config['d_debits']['min_fuel']
    max_fuel = config['d_debits']['max_fuel']
    nb_pts_fuel = config['d_debits']['nb_points_fuel']

    min_ox = config['d_debits']['min_oxidizer']
    max_ox = config['d_debits']['max_oxidizer']
    nb_pts_ox = config['d_debits']['nb_points_oxidizer']
